// Import Three.js core and loaders
...
const fbxFolder = './fbx/';
const fbxFiles = ["LusthAttack1.fbx","LusthAttack2.fbx","LusteIdleColored.fbx","LusteBite.fbx",'MariaSwordIdle.fbx', 'MariaSwordRun.fbx', 'MariaSwordSlash.fbx', 'Dwarf Idle.fbx',];
